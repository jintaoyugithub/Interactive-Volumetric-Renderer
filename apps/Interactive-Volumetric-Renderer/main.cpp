...
public:
  ExampleCubes(const char *_name, const char *_description, const char *_url)
      : entry::AppI(_name, _description, _url), m_pt(0), m_r(true), m_g(true),
        m_b(true), m_a(true) {}
  ...
  bool update() override {
    if (!entry::processEvents(m_width, m_height, m_debug, m_reset,
      ...
      /*                         ? IMGUI_MBUT_MIDDLE*/
      /*                         : 0),*/
      /*                m_mouseState.m_mz, uint16_t(m_width),
       * uint16_t(m_height));*/

      /*showExampleDialog(this);*/
      /**/
      /*ImGui::SetNextWindowPos(ImVec2(m_width - m_width / 5.0f
       * - 10.0f, 10.0f),*/
      ...
      /*ImGui::Combo("##topology", (int *)&m_pt, s_ptNames,*/
      /*             BX_COUNTOF(s_ptNames));*/
      /**/
      /*ImGui::End();*/
      /**/
      /*imguiEndFrame();*/
